const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_TAUNT] =
    {
        .effect = EFFECT_TAUNT, // Might keep this as is
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SNATCH] =
    {
        .effect = EFFECT_SNATCH, // Might keep this
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 3,
    ...
    [MOVE_POISON_TAIL] =
    {
        .effect = EFFECT_POISON_TAIL, // TODO: Toxic Poison hit
        .power = 120,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 16,
